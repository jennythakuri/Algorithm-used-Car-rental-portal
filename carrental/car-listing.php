...
$criteria = [
    ...
    'fueltype' => isset($_POST['fueltype']) ? filter_var($_POST['fueltype'], FILTER_SANITIZE_STRING) : null,
    'minprice' => isset($_POST['minprice']) && is_numeric($_POST['minprice']) ? $_POST['minprice'] : 0,
    'maxprice' => isset($_POST['maxprice']) && is_numeric($_POST['maxprice']) ? $_POST['maxprice'] : 10000,
];

$allCars = getAllCars();
$filteredCars = filterCars($allCars, $criteria);

$sortBy = isset($_POST['sortBy']) ? $_POST['sortBy'] : 'PricePerDay';
$order = isset($_POST['order']) ? $_POST['order'] : 'asc';
$sortedCars = sortCars($filteredCars, $sortBy, $order);

function getRecentlyAddedCars()
{
    global $dbh;
